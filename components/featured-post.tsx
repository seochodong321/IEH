...
export function FeaturedPost({ post }: { post: Post }) {
  return (
    <Link
      href={`/posts/${post.id}`}
      className="group grid overflow-hidden rounded-2xl bg-card ring-1 ring-foreground/10 transition-shadow hover:shadow-lg md:grid-cols-2"
    >
      <div className="relative aspect-[16/10] bg-gradient-to-br from-blue-500 to-indigo-600 md:aspect-auto md:min-h-[260px]">
        {post.imageUrl ? (
